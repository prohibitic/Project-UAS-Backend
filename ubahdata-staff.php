<?php
    ...
    $query="SELECT * FROM datatabel WHERE kode_barang=" . $id;
    ...
    <div>
      <br><h3 align="center">MASUKAN DATA BARANG</h3>
        <form method="POST" action="prosesedit.php">
          <table align="center">
            <tr>
              <td><input type="number" placeholder="KODE" name="kode_barang" required="required" value="<?php echo $data['kode_barang']; ?>"> </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <a href="data-barang-staff.php" style="text-decoration:none;">Kembali</a><td>
            </tr>
          </table>
        </form>
    </div>
