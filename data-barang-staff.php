...
while($tampil = mysqli_fetch_array($ambildata)){
    ...
    <tr>
        ...
        <td><button style='background-color:#1d213d; width:90%'><i class='fas fa-book'><a href='tampil-barang-staff.php?kode=$tampil[kode_barang]'>Details</a></i></button></td>
        <td><button style='background-color:#c91e24; width:90%'><i class='fas fa-trash'><a href='ubahdata-staff.php?kode=$tampil[kode_barang]'>Edit</a></i></button></td>
    </tr>";
    $no++;
}
?>
